...
<table cellpadding = "10">
	<tr>
		...
		<td>[(/mob/GM/verb/Teach_Self_To_Animal in verbs) ? "<a href='?src=\ref[src];action=teach_selftoanimal'>Animagus Transfiguration</a>" : "Animagus Transfiguration"]</td>
	...
	<tr>
		...
		<td>[(/mob/GM/verb/Teach_Fulmine_Fulgur in verbs) ? "<a href='?src=\ref[src];action=teach_fulmine_fulgur'>Fulmine Fulgur</a>" : "Fulmine Fulgur"]</td>
...
mob/Topic(href,href_list[])
	...
	switch(href_list["action"])
		...
		if("teach_lumos")
			src:Teach_Lumos()
		if("teach_selftoanimal")
			src:Teach_Self_To_Animal()
		if("teach_fulmine_fulgur")
			src:Teach_Fulmine_Fulgur()