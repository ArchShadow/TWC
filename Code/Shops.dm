...
mob/TalkNPC/Vault_Salesman
	...
	New()
		...
		itemlist["Medium Vault - 1 platinum coins and 10 artifacts"]           = list("_med",    10)
		itemlist["Big Vault - 2 platinum, 50 gold coins and 25 artifacts"]     = list("_big",    25)
		itemlist["Huge Vault - 5 platinum coins and 50 artifacts"]             = list("_huge",   50)
		itemlist["2 Rooms Vault - 7 platinum, 50 gold coins and 75 artifacts"] = list("_2rooms", 75)
		itemlist["4 Rooms Vault - 10 platinum coins and 100 artifacts"]        = list("_4rooms", 100)
		itemlist["Luxury Vault - 15 platinum coins and 150 artifacts"]         = list("_luxury", 150)
		itemlist["HQ Vault - 20 platinum coins and 200 artifacts"]             = list("_hq",     200)
		itemlist["Wizard Vault - 30 platinum coins and 300 artifacts"]         = list("_wizard", 300)
